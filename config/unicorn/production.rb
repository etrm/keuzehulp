worker_processes 2
working_directory '/var/www/keuzehulp/current'
...
listen '/var/www/keuzehulp/shared/tmp/sockets/unicorn.sock', backlog: 64

# File containing the Unicorn process ID.
pid '/var/www/keuzehulp/shared/tmp/pids/unicorn.pid'

# Set the path of the log files inside the log folder of the testapp
stderr_path '/var/www/keuzehulp/shared/log/unicorn.log'
stdout_path '/var/www/keuzehulp/shared/log/unicorn.log'
...
before_fork do |server, worker|
  ...
  # end the old process...
  old_pid = '/var/www/keuzehulp/shared/tmp/pids/unicorn.pid.oldbin'
...
before_exec do |server|
  ENV["BUNDLE_GEMFILE"] = "/var/www/keuzehulp/current/Gemfile"
end
